    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    @foreach(array_chunk($marketing->all(), 3, true) as $row)
                        <div class="row">
                            <div class="card-deck">
                                @foreach($row as $item)
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{route('marketing.show', $item->slug)}}"
                                        ...
                                        <div>
                                            @foreach($item->tags as $tag)
                                                <a href="{{route('marketing.search-tag',$tag->id)}}" class="btn btn-outline-info btn-sm m-2">{{$tag->name}}</a>
                                            @endforeach
                                        </div>
                                    </div>
                                @endforeach
