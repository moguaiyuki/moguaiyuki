...
@section('content')
    ...
    {!! Form::model($programing, ['method'=>'PATCH', 'action'=>['Admin\ProgramingController@update', $programing->id], 'files'=>true]) !!}
    ...
    <div class="form-group">
        ...
        @forelse($tags as $tag_id => $tag_name)
            ...
            {!! Form::checkbox('tag[]', $tag_id, in_array($tag_id, $programing_tags), ['class'=>'checkbox-inline', 'id'=>$tag_name]) !!}
        @empty
