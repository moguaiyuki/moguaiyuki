...
@section('content')
    ...
    {!! Form::model($english, ['method'=>'PATCH', 'action'=>['Admin\EnglishController@update', $english->id], 'files'=>true]) !!}
    ...
    <div class="form-group">
        ...
        @forelse($tags as $tag_id => $tag_name)
            ...
            {!! Form::checkbox('tag[]', $tag_id, in_array($tag_id, $english_tags), ['class'=>'checkbox-inline', 'id'=>$tag_name]) !!}
        @empty
